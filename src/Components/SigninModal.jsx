...
const SigninModal = () => {
  return (
    <div>
      ...
      <button
        className=" small border border-[#21b0fe] text-[#21b0fe] font-medium rounded-full text-md px-5 py-2 text-center"
      ...
      <dialog
       ...
       "
      >
        <div className="modal-box rounded-[35px]  overflow-y-auto p-0 max-w-7xl mx-auto">
        <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="bg-[#e8e8e8] p-10 flex flex-col justify-between items-start w-full h-auto py-6">
              ...
              <div className="flex justify-center items-center w-full ">
                ...
                <Link
                  href="/"
                  className="lg:text-6xl text-3xl text-[#0c0c0c] font-bold heading"
                >
                  Oetology
                </Link>
              </div>
            ...
            <div className="lg:p-10 p-6 flex  flex-col justify-center bg-white">
              <h1 className="heading text-[#0c0c0c] text-center lg:text-left text-2xl">Sign in</h1>
              ...
              <div className="flex flex-col  items-center">
                <button
                  type="button"
                  className="w-full btn hover:bg-[#212121] heading text-lg mt-10 flex items-center justify-center h-16 px-4 t font-semibold text-center text-white rounded-xl bg-[#0c0c0c]  transition-all duration-500"
                >
                  Sign in
                </button>
                <h1 className="mt-4">
                  <a href="#" className="text-zinc-700 small ">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-col lg:flex-row gap-3  justify-center items-center mt-6">
                  ...
                  <button
                    type="button"
                    className="lg:w-40 w-full  btn small text-md bg-white hover:bg-zinc-50 flex items-center justify-center h-12 px-4 t font-semibold text-center text-[#0c0c0c] rounded-xl   transition-all duration-500"
                  >
                    <img
